...
describe("ProductForm", () => {
  ...
  it("should render form", async () => {
    ...
    expect(
      screen.getByRole("combobox", { name: /categories/i })
    ).toBeInTheDocument();
  });
  it("should populate form field when editing product", async () => {
  ...
  it.each([
    ...
    {
      scenario: "larger number greater than 1000",
      price: 10000,
  ...
  it("should disable the submit button upon submission", async () => {
    const { waitForFormToLoad, onSubmit } = renderComponent();
    onSubmit.mockReturnValue(new Promise((resolve, reject) => {}));
